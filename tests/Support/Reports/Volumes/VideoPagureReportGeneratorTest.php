...
use Biigle\Shape;
use Biigle\Modules\Reports\Support\Reports\Volumes\VideoPagureReportGenerator;
...
class VideoPagureReportGeneratorTest extends TestCase
{
    public function testProperties()
    {
        $generator = new VideoPagureReportGenerator;
        $this->assertEquals('video Pagure report', $generator->getName());
        $this->assertEquals('video_pagure_report', $generator->getFilename());
    ...
    public function testGenerateReport()
    {
        ...
        $generator = new VideoPagureReportGeneratorStub;
...
class VideoPagureReportGeneratorStub extends VideoPagureReportGenerator
{
    public $yaml;
